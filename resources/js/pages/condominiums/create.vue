...
const breadcrumbs: BreadcrumbItem[] = [{title:'Condominios', href:'/condominiums'}, {title:'Crear condominio', href:'#'}];
        ...
        <div class="border mx-auto w-9/10 md:w-7/10 lg:w-5/10 mt-4 p-4 rounded-md shadow-2xl">
            ...
            <form @submit.prevent="submit" class="space-y-5">
                ...
                <div class="grid gap-2 flex-1">
                    ...
                    <Select v-model="form.currency" class="px-3 py-2 dark:text-white dark:bg-zinc-900 w-auto" id="currency">
                        <SelectTrigger>
                ...
                <div class="grid gap-2 flex-1">
                    ...
                    <Select v-model="form.id_client" class="px-3 py-2 dark:text-white dark:bg-zinc-900 w-auto" id="id_client">
                        <SelectTrigger>
